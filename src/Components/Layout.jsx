                ...
                <div className="pt-4 border-t border-gray-200 mt-4">
                  <div className="flex justify-center space-x-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                      aria-label="Follow us on Facebook"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                      aria-label="Follow us on Instagram"
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12.017 0C8.396 0 7.996.014 6.797.067 5.59.12 4.694.347 3.915.67c-.806.326-1.49.96-2.065 1.735C1.275 3.18 1.048 4.076.67 5.283c-.052 1.2-.067 1.6-.067 5.22S.614 13.6.67 14.8c.12 1.207.347 2.103.67 2.882.326.806.96 1.49 1.735 2.065.785.575 1.68.802 2.887.67 1.2-.052 1.6-.067 5.22-.067s3.996.014 5.196.067c1.207.12 2.103.347 2.882.67.806.326 1.49.96 2.065 1.735.575.785.802 1.68.67 2.887-.052 1.2-.067 1.6-.067 5.22s.014 3.996.067 5.196c.12 1.207.347 2.103.67 2.882.326.806.96 1.49 1.735 2.065C20.82 22.725 21.716 22.952 22.923 23.33c1.2.052 1.6.067 5.22.067s3.996-.014 5.196-.067c1.207-.12 2.103-.347 2.882-.67.806-.326 1.49-.96 2.065-1.735.575-.785.802-1.68.67-2.887-.052-1.2-.067-1.6-.067-5.22s.014-3.996.067-5.196c.12-1.207.347-2.103.67-2.882.326-.806.96-1.49 1.735-2.065C22.725 3.18 22.952 2.284 23.33 1.077c.052-1.2.067-1.6.067-5.22s-.014-3.996-.067-5.196c-.12-1.207-.347-2.103-.67-2.882C23.33.806 22.646.172 21.84-.002c-.785-.326-1.68-.553-2.887-.67C17.753-.052 17.353-.067 13.733-.067s-3.996.014-5.196.067c-1.207.12-2.103.347-2.882.67-.806.326-1.49.96-2.065 1.735C3.18 1.275 2.284 1.502 1.077 1.88-.123 1.932-.523 1.947-4.143 1.947z"/>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-blue-400 hover:bg-blue-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                      aria-label="Follow us on Twitter"
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-red-600 hover:bg-red-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                      aria-label="Subscribe to our YouTube channel"
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-blue-700 hover:bg-blue-800 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group"
                      aria-label="Connect with us on LinkedIn"
                    >
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/" className="text-gray-300 hover:text-white transition-colors cursor-pointer">Home</a></li>
                <li><a href="/events" className="text-gray-300 hover:text-white transition-colors cursor-pointer">Events</a></li>
                <li><a href="/register" className="text-gray-300 hover:text-white transition-colors cursor-pointer">Register</a></li>
                <li><a href="/contact" className="text-gray-300 hover:text-white transition-colors cursor-pointer">Contact</a></li>
                <li><a href="/admin" className="text-gray-300 hover:text-white transition-colors cursor-pointer">Admin</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-300">
                <p><a href="mailto:maranatha@gmail.com" className="hover:text-white transition-colors cursor-pointer">maranatha@gmail.com</a></p>
                <p><a href="tel:+254715970249" className="hover:text-white transition-colors cursor-pointer">0715970249</a></p>
                <p>Kenya, Thika</p>
              </div>
            </div>
          </div>
